                        ...
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="panel panel-primary col-md-offset-1 col-md-4">
                              <div class="panel-heading">
                            	...
                            	<div class="panel-body">
                              		<div class="span12 well">
                                        ...
                                        <form action="imprimir_rel_individual.php" target="_blank" method="post">
                             ...
                             <div class="panel panel-primary col-md-6 col-md-offset-1">
                              ...
                              <div class="panel-body">
                                  <div class="span12 well">
                                    <form target="_blank" action="imprimir_pessoa.php" method="post">
                            ...
                            <div class="panel panel-primary col-md-offset-3 col-md-6">
                              <div class="panel-heading">
                                <h3 class="panel-title">Gráfico de Pessoas</h3>
                              </div>
                               <div class="panel-body">
                                    <div class="span12 well">
                                        <form target="_blank" action="grafico_pessoas.php" method="post">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr height="40">
                                                    <td colspan="2"><b>Período</b></td> 
                                                </tr>
