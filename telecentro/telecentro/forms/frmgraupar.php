					...
					<div class="row">
						<div class="col-lg-12">
							<h1 class="page-header">
								Cadastro de Grau Parentesco<small>  </small>
							</h1>
							<ol class="breadcrumb">
								<li class="">
								...
								<li class="">
                                <i class="glyphicon glyphicon-menu-right"></i> Lista dos Graus de Parentesco
								</li>
								<li class="active">
									<i class="glyphicon glyphicon-menu-right"></i> Cadastrar Grau Parentesco
								</li>
							</ol>
						</div>
					</div>
									...
									<fieldset>
										<legend><font color="red">*</font> Campo Obrigatório</legend>
										 <div class="form-group">
											...
											<div class="col-sm-4">
											  <input type="text" class="form-control" name="nomegraupar" id="nomegraupar" placeholder="Nome do Grau de Parentesco" required> 
											</div>
										  </div>								 
										  	<div class="form-group"> 
