						...
						<div>
							<form class="form-horizontal" role="form"  method = "POST" action = " ">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<select class="form-control" name="instrutor" disabled><option>Selecionar Responsável</option>
											<?php 
									...
									<div class="col-sm-3"> 
										<select class="form-control" name="fornecedor" disabled><option>Selecionar Fornecedor</option>
											<?php 
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input type="text" class="form-control" disabled  name="dtsaida" onkeypress="mascara(this, '##/##/####')" value="<?php echo $manutencao['DTSAIDA']; ?>"  maxlength="10">
									</div> 
									<label class="control-label col-sm-2 col-md-offset-1" for="dtretorno"><font color="red">*</font> Data do Retorno:</label>
									<div class="col-sm-2">
										<input type="text" class="form-control" disabled id="dtretorno" value="<?php echo $manutencao['DTRETORNO']; ?>" name="dtretorno" onkeypress="mascara(this, '##/##/####')" maxlength="10">
									</div>
								</div>
								<div class="form-group">
									<div id="divmanutencao">
										...
										<div class="col-sm-3">
									 	 <textarea class="form-control" rows="3" disabled  name="descricao" id="obs" readonly required><?php echo $manutencao['DSMANUTENCAO']; ?></textarea>
									 	</div>

									 	<label class="control-label col-sm-2" for="descricao"><font color="red">*</font> Obs Retorno:</label>
										<div class="col-sm-3">
									 	 <textarea class="form-control" rows="3" disabled name="obsretorno" id="obs" required><?php echo $manutencao['OBS']; ?></textarea>
									 	</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3 "> 
									<select class="form-control" disabled onchange="select(this)" id="form_prepare" name="equipamentos"><option>Selecionar Equipamento</option>
										<?php 
								...
								<div class="col-sm-offset-9 col-sm-10">
									<button type="button"  onClick="JavaScript: window.history.back();" class="btn btn-primary">Voltar</button>
								</div>
							</form>
							<!-- Modal manutencao-->
